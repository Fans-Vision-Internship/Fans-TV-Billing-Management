...
class laporanController extends Controller
{
    public function laporanPelanggan(Request $request)
    {
        ...
        $pelanggan = Pelanggan::with(['pembayaran' => function ($query) use ($year) {
            $query->whereYear('tanggal', $year) // Filter berdasarkan tahun
        ...
        return view('laporan.index', compact('pelanggan', 'year'));
    }
    public function exportExcel(Request $request)
    {
        ...
        $fileName = 'Laporan_Pelanggan_' . $year . '.xlsx';
    ...
    public function exportPDF(Request $request)
    {
        ...
        $html = view('laporan.pelanggan_pdf', compact('pelanggan', 'year'))->render();
        ...
        $dompdf->render();
        $dompdf->stream('Laporan_Pelanggan_' . $year . '.pdf', ['Attachment' => true]);
    }
